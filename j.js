...
if (reversed == null) { reversed = false; }
	...
	this.shape.graphics.f("#0066CC").s().p("EhZSA0qMAAAhpTMCylAAAMAAABpTg");
	this.shape.setTransform(571.45,336.975);
...
p.nominalBounds = new cjs.Rectangle(0,0,1142.9,674);


(lib.DogRun = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance.setTransform(0.45,14.35,0.5,0.5);

	this.instance_1 = new lib.CachedBmp_6();
	this.instance_1.setTransform(0.45,6.45,0.5,0.5);

	this.instance_2 = new lib.CachedBmp_7();
	this.instance_2.setTransform(-0.2,1.4,0.5,0.5);

	this.instance_3 = new lib.CachedBmp_8();
	this.instance_3.setTransform(-0.7,-0.8,0.5,0.5);

	this.instance_4 = new lib.CachedBmp_9();
	this.instance_4.setTransform(-1.75,0.15,0.5,0.5);

	this.instance_5 = new lib.CachedBmp_10();
	this.instance_5.setTransform(-2.5,4.15,0.5,0.5);

	this.instance_6 = new lib.CachedBmp_11();
	this.instance_6.setTransform(0.45,14.35,0.5,0.5);

	this.instance_7 = new lib.CachedBmp_12();
	this.instance_7.setTransform(0.45,6.45,0.5,0.5);

	this.instance_8 = new lib.CachedBmp_13();
	this.instance_8.setTransform(-0.2,1.4,0.5,0.5);

	this.instance_9 = new lib.CachedBmp_14();
	this.instance_9.setTransform(-0.7,-0.8,0.5,0.5);

	this.instance_10 = new lib.CachedBmp_15();
	this.instance_10.setTransform(-1.75,0.15,0.5,0.5);

	this.instance_11 = new lib.CachedBmp_16();
	this.instance_11.setTransform(-2.25,4.15,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-2.5,-0.8,450.5,403.3);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.hit).wait(59).to({_off:false},0).wait(1));

	// Dog_Run
	this.instance = new lib.DogRun("synched",0);
	this.instance.setTransform(1362.9,343.9,1,1,0,0,0,223.1,201.2);
...
an.compositions['7C529E027E44BF4F983C767C3FEB469B'] = {
